    ...
    if l == 10 or l == 13: # verificar la longitud correcta
        ...
        if cp >= 1 and cp <= 22: # verificar codigo de provincia
            ...
            if tercer_dig >= 0 and tercer_dig < 6 : # numeros enter 0 y 6
                ...
                raise ValidationError(u'Tercer digito invalido') 
        else:
            raise ValidationError(u'Codigo de provincia incorrecto') 
    else:
        raise ValidationError(u'Longitud incorrecta del numero ingresado')
